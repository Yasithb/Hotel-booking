...
@section('title', 'Add New Guest - Hotel Booking System')
                ...
                <div class="card-body">
                    <form id="guestForm">
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Privacy Notice:</strong> All guest information is stored securely and used only for hotel services and legal requirements. We comply with data protection regulations.
                        </div>
...
async function handleSubmit(e) {
    ...
    try {
        ...
        // Ask if user wants to create a booking for this guest
        setTimeout(() => {
            if (confirm('Guest created successfully! Would you like to create a booking for this guest?')) {
                window.location.href = `/bookings/create?guest_id=${response.id}`;
            } else {
...
async function validateEmail() {
    ...
    try {
        ...
        const response = await api.get(`/guests/check-email?email=${encodeURIComponent(email)}`);
        if (response.exists) {
